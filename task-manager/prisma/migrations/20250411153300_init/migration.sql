...
CREATE TABLE "User" (
    ...
    "image" TEXT,
    "subscriptionid" TEXT,
    "onbardingCompleted" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE INDEX "Comment_projectId_userId_idx" ON "Comment"("projectId", "userId");

-- CreateIndex
CREATE UNIQUE INDEX "Task_projectId_assigneeId_key" ON "Task"("projectId", "assigneeId");
